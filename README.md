...
From point of view of the diameter, the pagerangk attack and the high degree attack have a significantly impact on the diameter, in fact, with this kinds of attacks there is a great increasement of the diameter, before becoming 0, and hence this means a significant impact on the avarage shortest path and therefore also in the ability of two nodes to communicate.
